...
class SaleOrder(models.Model):
    ...
    # def tes_messaging(self):
    #     for rec in self:
    #         channel_id = rec.env['mail.channel'].search([('name','like','Sales Approval Notification')])

    #         channel_id.message_post(
    #             subject="Timesheet reminder",
    #             body="Nous vous informons que vous n'avez pas complété votre feuille de temps du",
    ...
    # channel_id.message_post(
    #     subject='Finance Canceled a Sales Order',
    #     body='''Finance Canceled Sales Order, Canceled Sales Order Number: ''',
