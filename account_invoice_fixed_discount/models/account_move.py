...
class AccountMoveLine(models.Model):
    ...
    def _get_price_total_and_subtotal_model(
        ...
        if self.discount_fixed != 0:
            ...
            # price_unit = (((quantity * price_unit) - self.discount_fixed) / quantity)
    ...
    # ):
    #     if self.discount_fixed != 0:
    #         discount = ((self.discount_fixed) / (self.price_unit * self.quantity)) * 100 or 0.00
    #         # discount = ((self.discount_fixed) / self.price_unit) * 100 or 0.00
    #         # price_unit = (((quantity * self.price_unit) - self.discount_fixed) / quantity)
